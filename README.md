...
### WARNING 
На выпадающем списке НЕ нажимать на область вне списка, иначе произойдет перезагрузка системы 
(ошибка внутри PySide 6.4.2). Чтобы закрыть список - достаточно выбрать из него элемент
...
Ссылка на шаблон в Figma: https://www.figma.com/file/YwawAtim7kjJh2jtd6R6sV/bookkeeper?t=evfIFTAXWlf8fdwq-6
